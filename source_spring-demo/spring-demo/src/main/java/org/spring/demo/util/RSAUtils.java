...
public class RSAUtils {
  ...
  public static String encrypt(String data)
      throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, IOException {
//    byte[] decode = java.util.Base64.getDecoder().decode(privateKey);
...
//    String encodeToString = java.util.Base64.getEncoder().encodeToString(encryptedData);
  ...
  public static String decrypt(String data)
      throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidKeySpecException, IllegalBlockSizeException, BadPaddingException, IOException {
//    byte[] decode = java.util.Base64.getDecoder().decode(publicKey);
...
//    byte[] bytes = java.util.Base64.getDecoder().decode(data);
  ...
  public static void main(String[] args)
      throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, IOException {
    String test = encrypt("hujj");
    String testDecrypt = decrypt(test);
