...
public class TestUntrustedDeserialEvent extends TimerTaskEvent {

  @Override
  public void run() {
    startTestUntrustedDeserial();
  }

  public void startTestUntrustedDeserial() {
    ...
    try {
      ...
      RMBMessageService.testUntrustedDeserial(bid);
